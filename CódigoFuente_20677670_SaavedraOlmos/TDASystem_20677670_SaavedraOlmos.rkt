...
; Dominio: system (list) X user (string).
; Recorrido: system (list).
; Descripción: Corresponde a una función modificadora del TDA Sistema. En su entrada recibe
; un sistema y un usuario. Su salida corresponde a un sistema con sus usuarios registrados.
...
; Recorrido: system (list).
; Descripción: Corresponde a una función modificadora del TDA Sistema. En su entrada recibe
; un sistema y un usuario. Su salida corresponde a un sistema con la lista de usuario logueado
; en base los usuarios registrados del sistema.
...
; Recorrido: system (list).
; Descripción: Corresponde a una función modificadora del TDA Sistema. En su entrada recibe
; un sistema y un usuario. Su salida corresponde a un sistema con la lista de usuario logueado vacía
